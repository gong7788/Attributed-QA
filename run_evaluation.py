...
def eval(df, qa_df, doc2dial_doc, test=False, test_num=1, eval_id=None):
    ...
    for index, row in df.iterrows():
        if index not in failed_doc_ids:
            qa_pair = qa_df.iloc[index]
            ...
            #save checkpoint
                ...
                checkpoint = os.path.join(checkpoint_dir, 'eval_{}_cp{}.csv'.format(eval_id, index))
...
if __name__ == "__main__":
    ...
    eval(df, qa_df, doc2dial_doc, test=True, test_num=1, eval_id=1)